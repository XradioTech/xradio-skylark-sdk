...
> 本工程对flash模块的读写、擦除的接口使用进行介绍。过程是：擦除flash，然后往flash写入数字0~255，最后读取出来。
>

### 操作说明：

> 1. 连接XR872AT_VER_V1_0板，编译工程，烧录镜像，启动。
> 3. 系统启动后，可以看到从flash读到的数字0~255。
...
├── main.c                      # 本工程的入口，进行flash读写、擦除示例说明
