 ...
 */
 ...
 #if !defined(LWS_WITH_ESP8266) && !defined(OPTEE_TA) && !defined(LWS_WITH_ESP32) && !defined(LWS_WITH_XRADIO)
  #include <poll.h>
  #include <netdb.h>
 ...
 #define random rand
  ...
  #include <unistd.h>
   ...
   #include <wolfssl/error-ssl.h>
    ...
    #undef MBEDTLS_CONFIG_FILE
    #define MBEDTLS_CONFIG_FILE "mbedtls/configs/config-xr-mini-cliserv.h"
