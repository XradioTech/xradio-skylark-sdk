...
#define PACKET_SPLICE_BUGFIX

#include "net/mqtt/MQTTPacket/MQTTPacket.h"
#include "stdio.h"
#include "net/mqtt/MQTTClient-C/MQTTXrRTOS.h" //Platform specific implementation header file
